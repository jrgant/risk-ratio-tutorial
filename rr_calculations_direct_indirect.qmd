...
subtitle: "Comparing Methods to Calculate Risk and Prevalence Ratios and Differences in R: Developing Intuition with a Hands-on Tutorial and Code"
...
For ease of reference, the following sections in this supplementary file share the numbered headings of the main manuscript to which they correspond. In addition, we have suppressed supporting citations for material already discussed and cited in the main manuscript.

# 2. Applied example using clinical data to calculate a crude risk ratio and risk difference
...
# 2.1 Direct estimation of a risk ratio and risk difference by hand

### Step 2.1a. Calculate the risk ratio
...
### Step 2.1b. Calculate the standard error for the risk ratio
...
### Step 2.1c. Calculate the 95% confidence interval for the risk ratio
...
### Step 2.1d. Calculate the risk difference
...
### Step 2.1e. Calculate the standard error for the risk difference
...
\begin{equation}
\begin{split}
\text{SE(RD)} & = \sqrt{ \frac{\text{Risk}_{\text{exposed}} (1 - \text{Risk}_{\text{exposed}})}{n_{\text{exposed}}} + \frac{\text{Risk}_{\text{unexposed}} (1 - \text{Risk}_{\text{exposed}})}{n_{\text{unexposed}}}} \\
...
### Step 2.1f. Calculate the confidence interval for the risk difference
...
## 2.2 Direct estimation of a risk difference using linear models
...
# 2.3 Direct estimation of a risk ratio using a log-binomial regression model
...
# 2.4 Direct estimation of a risk ratio using a modified Poisson model
...
# 2.5 Indirect estimation of risk ratio and risk difference from logistic regression models

## 2.5.1 Implementing the procedure yourself in R
...
## 2.5.2 Estimating a risk ratio using the `logisticRR` package

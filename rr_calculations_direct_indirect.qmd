...
glm_lin_bin_se <- sqrt(diag(vcov(glm_lin_bin_fit))[2])
glm_lin_bin_se <- unname(glm_lin_bin_se)

c(RD = glm_lin_bin_rd,
  SE = glm_lin_bin_se,
  `95% CL, Lower` = glm_lin_bin_rd - qnorm(0.975) * glm_lin_bin_se,
  `95% CL, Upper` = glm_lin_bin_rd + qnorm(0.975) * glm_lin_bin_se)
```
